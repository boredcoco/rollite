...
{
    [SerializeField] private string movement = "Use WASD keys to Move Plane. Note that there is a screen-wrap at all edges of this game. So if you are at the left screen boundary you will be teleported to the right, vice versa. This applies to top and bottom screen boundaries. Try going to each edge to see what happens!";
